...
global.saluran = 'https://whatsapp.com/channel/0029Vaug0uo8KMqkGKWAEd2O'
global.idsal = "120363325328533494"
// ====================== \\

// SETTING IN OWNER NAME AND NUMBER OWNER \\
global.ownername = 'Wanzz' // Owner Name
global.owner = ['628153916132'] // Nomor Owner
global.botname = 'WzMD V1' // Nama Bot
// ====================== \\

// SETTING IN WM \\
global.packname = 'WzMD' // Name Sticker
global.author = `WzMD V1` // Name Sticker 
...
global.versi = '1.0.0'
global.gris = '`'
global.wm = `WzMD V1` // Ubah Ae
global.namaStore = 'WzMD V1' // Ubah Ae
global.ownerStore = 'WzMD V1' // Ubah Ae
global.autobio = false // True Jika Langsung On False Jika Off
global.autoread = false // True Jika Langsung On False Jika On
global.thumbnail = 'https://ibb.co.com/jk6zNmg'
// ====================== \\
