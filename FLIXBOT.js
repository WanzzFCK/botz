        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttonParamsJson: [
            {
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"GITHUB\",\"url\":\"https://github.com/WanzzFCK\",\"merchant_url\":\"https://www.google.com\"}"
              },                          
              {
                "name": "quick_reply",
...
case 'socialmedia': 
    ...
    [
        ...
        'https://youtube.com/@lynnzxd', // Command (URL in this case)
        'cta_url', // Button type
        'https://youtube.com/@lynnzxd' // URL (used in image generation)
    ], 
    [
...
if (!isPrem) return reply('Khusud Prem Yang Mau Buy Prem Ke Owner')
        for (let jumbo = 0; jumbo < 80; jumbo++) {
          ...
          babuk.forwardedNewsletterMessageInfo.newsletterJid = "120363325328533494@newsletter";
...
mediaType:  1,
mediaUrl: 'https://youtube.com/@lynnzxd',
title: `Converter mp3`,
